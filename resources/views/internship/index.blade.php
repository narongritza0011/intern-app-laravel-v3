                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <!-- <div class="col-sm-12  col-md-6 col-lg-6">
                            ...
                            <input class="form-control text-warning" type="text" id="status">
                        </div> -->
                        ...
                        <div class="col-sm-12  col-md-6 col-lg-6">
                            ...
                            <select class="form-select form-control " aria-label="Default select example" name="status" required>
                                <option value="กำลังรออนุมัติ" selected>กำลังรออนุมัติ</option>
...
@section('script')
<script>
    var route_index = "{{ route('internship.index') }}"
    ...
    function editData(id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                // $('#profile').val(response.cus.profile)
                document.getElementById("profile").src = 'http://localhost/intern-app-full/public/' + response.cus.profile;
    ...
    function selected(data) {
        ...
        //   htmltext = htmltext + `<option value="${status[a]}">${status[a]}</option>`
        // }
