    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('UploadFileIntern.save')}}" method="post" enctype='multipart/form-data'>
                    @csrf
                    <input class="file-input" type="file" id="image" name="profile" accept="image/png,image/jpeg" required>
                    <input class="form-control  col-9" type="text" name="id_File" id="id_File">
                    <input class="form-control  col-9" type="text" name="phone_File" id="phone_File">
                    <input class="form-control  col-9" type="text" name="full_name_File" id="full_name_File">
            </div>
    ...
    function editData(id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("profile").src = '/intern-app-laravel-v3-main/public/' + response.cus.profile;
