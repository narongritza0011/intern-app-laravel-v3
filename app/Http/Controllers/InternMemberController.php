        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('edit', function ($data) {
                    return '<a class="btn btn-warning mr-1" onclick="editData(' . $data->id . ')"><i class="fas fa-eye"></i> </a> <a class="btn btn-primary mr-1" href="internship/resume/' . $data->id . '" ><i class="fas fa-file"></i>';
                })
